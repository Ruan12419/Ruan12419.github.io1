...
function showPetLocation(name) {
  var petLocation = "-8.1181473,-34.8994462"; // Substitua com a latitude e longitude do pet
  var mapUrl = "https://maps.google.com/maps?q=" + petLocation + "&z=15&output=embed";
  
  document.getElementById("map-" + name).innerHTML = "<iframe width='100%' height='100%' frameborder='0' style='border:0' src='" + mapUrl + "' allowfullscreen></iframe>";
  console.log("foi")
}
